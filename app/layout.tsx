...
export const metadata: Metadata = {
  title: "Ravishankar M | Personal Portfolio",
  description: "Ravishankar is a full stack developer",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} relative overflow-x-hidden bg-gray-50 pt-28 text-gray-950 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
